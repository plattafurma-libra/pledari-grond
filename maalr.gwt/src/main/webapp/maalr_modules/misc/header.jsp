...
<fmt:setBundle basename="de.uni_koeln.spinfo.maalr.webapp.i18n.text" />
		...
		<%-- FALLBACK LOCALE: accept "sm > surmiran", otherwise force to "de > deutsch" --%>
		<% 
...
<div id="navi_head">
	...
	<div id="languages-widget">
		<a href="?locale=sm" class='<%=(session.getAttribute("locale").equals("sm"))?"lang_selected":"navi_a_common"%>'>R</a>
...
<div id="dic_navi_head">
	...
	<div id="sm_brand_title" class="dict_navi_item selected"></div>
