...
public class EntryFilterUserCell extends AbstractCell<LexEntryCellWrapper> {
	...
	interface EntryListUiRenderer extends UiRenderer {
		...
		void onBrowserEvent(EntryFilterUserCell cell, NativeEvent event, Element element, LexEntryCellWrapper wrapper);
	}
	...
	public EntryFilterUserCell(ListFilter filter) {
		super("click");
		this.filter = filter;
	}
