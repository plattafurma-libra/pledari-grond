...
<body>
	...
	<div id="content">
		<div class="error">An error occurred when accessing the index.</div>
		...
		<div class="solution">Bitte melden Sie sich als Administrator an und <a href="/admin/rebuildIndex.html">erzeugen Sie den Suchindex neu.</a></div>
	</div>
</body>
</html>