...
<div id="navi_bottom">
	...
	<ul id="navi_bottom_menu">
		...
		<li><a href="${dictContext}/assets/binary/grammatica.pdf" target="_blank"><i></i><span class=""><fmt:message key="maalr.navi.grammatica" /> </span></a></li>		
	...
	<ul id="navi_bottom_social">
		...
		<li><a href="#"><img src="${dictContext}/assets/img/like.png"><span class="count">2422</span></a></li>
	</ul>
</div>