...
public class AcceptAfterUpdateOperation extends BaseOperation implements IDBOperation {
	...
	public AcceptAfterUpdateOperation(LexEntry entry, LemmaVersion suggested, LemmaVersion modified) {
		this.entry = entry;
	...
	public void execute() throws OperationRejectedException {
		...
		try {
			...
			Database.getInstance().acceptAfterUpdate(entry, suggested, modified);
